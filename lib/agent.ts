...
const REMEMBER_TOOL: ChatCompletionTool = {
  ...
  function: {
    ...
    description: [
      ...
      "A person's NAME + relationship (wife, girlfriend, boss, friend) is ALWAYS a save — call",
      "remember in that same turn, even mid-conversation.",
      "WHEN NOT to call: small talk, questions, one-off jokes, transient chatter.",
      "CRITICAL: if your reply acknowledges a new lasting fact ('Noted', 'Got it'), you MUST call",
      "remember for it in the SAME turn — acknowledging without saving means the fact is lost forever.",
      "",
      "RULES:",
